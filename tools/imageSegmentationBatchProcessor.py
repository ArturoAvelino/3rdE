...
import json
from read_json_plot_contour_objects import read_and_plot_segmentations
...
def process_image_segmentations(input_dir, image_pattern="capt*.jpg"):
    """
    ...
    for image_file in image_files:
        try:
            ...
            read_and_plot_segmentations(json_file, output_path)
...
def main():
    ...
    try:
        process_image_segmentations(input_dir)
